    ...
    whereClause(req,res,filters, currentUser, function (err, clause,q,limit,offset,al,status) {
        ...
        getEmployee(emp_id,function(user){
            ...
            db.metric_role_response.findAll({
                ...
                where: {account_id: user.account_id,active: true, status:1, last_updated: { $gt:filters.timestamp  || 0 }},
                ...
                async.forEachSeries(tiOs,function(tiO,callback)
                {
                    ...
                    db.metric_role_response.findAll({
                        where: {account_id: user.account_id,active: true, status:1,metric_category_id: tiO.metric_category_id, last_updated: { $gt:filters.timestamp || 0 } },
                    ...
                    async.forEachSeries(queryObject,function(qO,callback2){
                        ...
                        db.metric_category.findOne({
                            ...
                            where: { global_metric_category_id : qO.metricCategory,active: true ,account_id: user.account_id}
                        }).then(function(mc) {
                            ...
                            if(mc){
                                ...
                                db.metrics_definition.findAll({
                                    ...
                                    where: {global_metric_id: {in: metIdsArray}, active: 1,account_id:user.account_id},
