...
module.exports = function(sequelize , DataTypes){
    var Agents = sequelize.define('agent', {
        ...
        keyMilestone1: DataTypes.BIGINT,
        keyMilestone2: DataTypes.BIGINT,
        keyMilestone3: DataTypes.BIGINT,
        keyMilestone4: DataTypes.BIGINT,
        keyMilestone5: DataTypes.BIGINT,
        keyMilestone6: DataTypes.BIGINT,
